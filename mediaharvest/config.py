...
DEFAULTS: Dict[str, Any] = {
    ...
    "music.enabled": True,
    "music.quality": "best",
    "music.expand_playlists": True,
    "music.playlist_limit": 200,
    "music.lyrics": True,
    "music.cover": True,
    "music.tags": True,
    "music.lrc_file": False,
    # 网络
    "network.proxy": "",
    "network.user_agent": "",
    "network.cookie": "",
...
SCHEMA: Dict[str, Tuple[str, str]] = {
    ...
    "music.enabled": ("启用音乐通道", "true / false；识别音乐站点并按音频流抓取"),
    "music.quality": ("音质档位", "best 最高 / lossless 仅无损 / high / medium / low 省流"),
    "music.expand_playlists": ("展开专辑与歌单", "true / false；关掉则只抓单个目标"),
    "music.playlist_limit": ("单个专辑/歌单最多抓多少首", "正整数"),
    "music.lyrics": ("抓取歌词", "true / false"),
    "music.cover": ("抓取并嵌入封面", "true / false"),
    "music.tags": ("写入音乐标签（ID3/Vorbis/MP4）", "true / false"),
    "music.lrc_file": ("额外保存 .lrc 歌词文件", "true / false"),
